...
namespace LiveSplit.Skyrim
{
    public partial class SkyrimSettings : UserControl
    {
        ...
        public bool DarknessReturns { get; set; }
        ...
        private const bool DEFAULT_DARKNESSRETURNS = false;
        ...
        public SkyrimSettings()
        {
            ...
            this.chkDarknessReturns.DataBindings.Add("Checked", this, "DarknessReturns", false, DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.DarknessReturns = DEFAULT_DARKNESSRETURNS;
        }
        ...
        public XmlNode GetSettings(XmlDocument doc)
        {
            ...
            settingsNode.AppendChild(ToElement(doc, "DarknessReturns", this.DarknessReturns));
        ...
        public void SetSettings(XmlNode settings)
        {
            ...
            this.DarknessReturns = ParseBool(settings, "DarknessReturns", DEFAULT_DARKNESSRETURNS);
